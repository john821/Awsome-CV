...
\begin{cventries}
    ...
    \begin{figure}[h]
    \includegraphics[height=0.7cm]{fwd}
    \includegraphics[height=0.7cm]{scb}
    \includegraphics[height=0.7cm]{axa}
    \includegraphics[height=0.7cm]{palo}
    \includegraphics[height=0.7cm]{solocal}
    \includegraphics[height=0.7cm]{carrefour}
    \includegraphics[height=0.7cm]{leclerc}
    \includegraphics[height=0.7cm]{leroy}
    \end{figure}
