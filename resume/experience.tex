  ...
  \cventry
    ...
    {March 2019 - Oct. 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {---}
        \item {Achievement: SCBLife mobile app, a a one-stop shop for managing your insurance and accessing information right from your cell phone}
      \end{cvitems}
    }
    {
      \#Agile ~
  ...
  \cventry
    ...
    {Jan. 2017 - Feb. 2019} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {---}
        \item {Achievement: MyAXA mobile app & Digital sales application}
      \end{cvitems}
    }
    {
      \#Agile ~
