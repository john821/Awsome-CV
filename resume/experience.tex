...
\begin{cventries}
    ...
    \begin{figure}[h]
    \includegraphics[height=0.5cm]{fwd}
    \includegraphics[height=0.5cm]{scb}
    \includegraphics[height=0.5cm]{axa}
    \includegraphics[height=0.5cm]{palo}
    \includegraphics[height=0.5cm]{solocal}
    \includegraphics[height=0.5cm]{carrefour}
    \includegraphics[height=0.5cm]{leclerc}
    \includegraphics[height=0.5cm]{leroy}
    \end{figure}
