  ...
  \cventry
    ...
    {Oct. 2020 - Present} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \{---}
        \item {Achievements: Thailand’s 1st end-to-end fully automated digital sales process}
      \end{cvitems}
    }
    {
      \#Agile ~
  ...
  \cventry
    ...
    {March 2019 - Oct. 2020} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \{---}
        \item {Achievements: SCBLife mobile app, a a one-stop shop for managing your insurance and accessing information right from your cell phones}
      \end{cvitems}
    }
    {
      \#Agile ~
