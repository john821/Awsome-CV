...
\begin{cventries}
    ...
    \begin{figure}[h]
    \includegraphics[height=1cm]{fwd}
    \includegraphics[height=1cm]{scb}
    \includegraphics[height=1cm]{axa}
    \includegraphics[height=1cm]{palo}
    \includegraphics[height=1cm]{solocal}
    \includegraphics[height=1cm]{carrefour}
    \includegraphics[height=1cm]{leclerc}
    \includegraphics[height=1cm]{leroy}
    \end{figure}
